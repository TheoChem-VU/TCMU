...
class NMRJob(Job):
    ...
    The job will first run an :class:`tcmu.job.adf.ADFJob` calculation at the SAOP/TZ2P level of theory to prepare for the NMR program of AMS.
...
if __name__ == "__main__":
    with NMRJob(test_mode=True) as job:
        job.molecule(r"D:\Users\Yuman\Desktop\PhD\tcmu\examples\job\water_dimer.xyz")
