...
def get_functional(functional_name: str) -> Result:
    ...
    Return:
        A :class:`Result <tcmu.results.result.Result>` object containing information about the functional if it exists. Else it will return ``None``.
...
def get_available_functionals():
    ...
    Returns:
        : A :class:`Result <tcmu.results.result.Result>` object containing information about all available XC-functionals.
            ...
            The values contain the following information:
                ...
                - ``adf_settings`` **(:class:`Result <tcmu.results.result.Result>`)** - the settings that are used to select the functional in the ADF input.
