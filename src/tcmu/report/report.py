...
from tcmu.report.formatters.generic import WordFormatter
from tcmu.report.formatters.xyz import StandardXYZFormatter
...
class SI:
    ...
    def add_xyz(self, obj: Union[str, Result, pl.Path], title: Union[str, None] = None, formatter: WordFormatter = StandardXYZFormatter()) -> None:
        ...
        Args:
            obj: A string specifying a calculation directory or a `tcmu.results.Result` object from a calculation.
